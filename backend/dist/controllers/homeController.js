...
const findHomesByUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { username } = req.params;
        const homes = yield homeService.findHomesByUser(username);
        res.json(homes);
    }
    catch (error) {
...
const updateHomeUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { streetAddress } = req.params;
        const { usernames } = req.body;
        const updatedHome = yield homeService.updateHomeUsers(streetAddress, usernames);
